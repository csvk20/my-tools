...
" Config files
call NERDTreeHighlightFile('ini', 'darkgreen', 'none', 'yellow', '#151515')
call NERDTreeHighlightFile('yml', 'darkgreen', 'none', 'yellow', '#151515')
call NERDTreeHighlightFile('yaml', 'darkgreen', 'none', 'yellow', '#151515')
...
call NERDTreeHighlightFile('xml', 'darkgreen', 'none', 'green', '#151515')
" Web files
call NERDTreeHighlightFile('html', 'magenta', 'none', '#ff00ff', '#151515')
call NERDTreeHighlightFile('css', 'darkcyan', 'none', 'cyan', '#151515')
" Scripting languages
call NERDTreeHighlightFile('js', 'darkyellow', 'none', '#ffa500', '#151515')
call NERDTreeHighlightFile('ts', 'darkyellow', 'none', '#ffa500', '#151515')
call NERDTreeHighlightFile('py', 'darkyellow', 'none', '#ff00ff', '#151515')
" CPP and C related
call NERDTreeHighlightFile('cpp', 'darkyellow', 'none', '#ff00ff', '#151515')
call NERDTreeHighlightFile('c', 'lightblue', 'none', '#ff00ff', '#151515')
call NERDTreeHighlightFile('h', 'magenta', 'none', '#ff00ff', '#151515')
call NERDTreeHighlightFile('cmake', 'darkgreen', 'none', '#ff00ff', '#151515')
" Text files
call NERDTreeHighlightFile('md', 'darkmagenta', 'none', '#ff00ff', '#151515')
call NERDTreeHighlightFile('markdown', 'darkmagenta', 'none', '#ff00ff', '#151515')
call NERDTreeHighlightFile('org', 'darkmagenta', 'none', '#ff00ff', '#151515')
call NERDTreeHighlightFile('txt', 'darkmagenta', 'none', '#ff00ff', '#151515')
" Less used
