...
" strings
syn region pythonString		start=+[uU]\='+ end=+'+ skip=+\\\\\|\\'+ contains=pythonEscape,@NoSpell
syn region pythonString		start=+[uU]\="+ end=+"+ skip=+\\\\\|\\"+ contains=pythonEscape,@NoSpell
syn region pythonRawString	start=+[uU]\=[rR]'+ end=+'+ skip=+\\\\\|\\'+ contains=@NoSpell
syn region pythonRawString	start=+[uU]\=[rR]"+ end=+"+ skip=+\\\\\|\\"+ contains=@NoSpell
...
"syn match pythonStringChars  "['"]"
syntax match OperatorChars "?\|+\|-\|\*\|:\|<\|>\|&\||\|!\|\~\|%\|=\|/"
syn region DocString	start=+[uU]\="""+ end=+"""+ contains=pythonEscape,@Spell
syn region DocString	start=+[uU]\='''+ end=+'''+ contains=pythonEscape,@Spell
syn match   pythonDeco /@\%(.\%({{{\|}}}\)\@!\)*$/
...
if version >= 508 || !exists("did_python_syn_inits")
  ...
  HiLink pythonDeco		Decorator
  HiLink pythonBraces    	Function
  HiLink pythonParens           Statement
  HiLink OperatorChars          Operator
  HiLink pythonStringChars          Operator
  HiLink pythonEndColons       	Function
